...
const LineChartComponent: React.FC<ChartProps> = ({ data = [], dataKey = "value", title, isCurrency = false, isHourly = false }) => {
    ...
    return (
        <div className="chart-wrapper">
            ...
            <ResponsiveContainer width="100%" height={300} minWidth={300}>
                <LineChart data={formattedData} margin={{ top: 50, right: 30, left: 20, bottom: 50 }}>
                    <defs>
                        <linearGradient id="colorMatrixLine" x1="0" y1="0" x2="0" y2="1">
